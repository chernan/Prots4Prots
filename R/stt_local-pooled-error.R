...
#' 2003 and tests difference between medians relative to the local intensity 
#' variability. 
...
#' @param binVal Size of the bins used to compute local variance.
...
applyAndReportLPE <- function(experiment, control, 
    ...
    cat('',
        ...
        '> doi:10.1093/bioinformatics/btg264',
        '> ',
        '> Usage for quantitative proteomics data suggested by Bantscheff et al. (2007).',
        '> ',
        '> R package for LPE :',
